...
<!--  This is fuse_html_xrefs.xsl which is included in all fuse-* DocBook stylesheets that have an HTML 
      output target. It modifies how link text is generated for HTML output targets. -->
